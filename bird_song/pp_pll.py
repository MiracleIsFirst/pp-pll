...
if __name__ == '__main__':
    data = pd.read_csv('BirdSong.txt', header=None)
    ...
    data['TL'] =  list(map(lambda x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13 : \
       [x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13].index(max([x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13])),data[header_num-14],data[header_num-13],data[header_num-12],data[header_num-11],data[header_num-10],data[header_num-9],data[header_num-8],data[header_num-7],data[header_num-6],data[header_num-5],data[header_num-4],data[header_num-3],data[header_num-2]))
    data['PL'] =  list(map(lambda x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13: \
       list((np.where(np.array([x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13])))[0]),data[header_num-14-13],data[header_num-13-13],data[header_num-12-13],data[header_num-11-13],data[header_num-10-13],data[header_num-9-13],data[header_num-8-13],data[header_num-7-13],data[header_num-6-13],data[header_num-5-13],data[header_num-4-13],data[header_num-3-13],data[header_num-2-13]))
